...
define('WT_BOOTSTRAP_CSS_URL',               WT_STATIC_URL . 'bootstrap-3.3.0/css/bootstrap.min.css');
define('WT_BOOTSTRAP_JS_URL',                WT_STATIC_URL . 'bootstrap-3.3.0/js/bootstrap.min.js');
